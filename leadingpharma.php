<?php include("header.php"); ?>
        ...
        <div class="container">
          <nav>
            <ol class="breadcrumb mb-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Leading Pharmaceutical Exporter</li>
            </ol>
          </nav>
        </div><!-- /.container -->
      </div><!-- /.breadcrumb-area -->
    ...
    <div class="heading-layout2 text-center mt-30">
        <h3 class="heading-title">Leading Pharmaceutical <span style="color:#ed6f1e;">Exporter</span></h3>
    </div><!-- /heading -->
    ...
    <section class="banner-layout5 py-0 mb-30" style="align-items: center;">
      <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-5 px-0 d-flex justify-content-end">
                <div class="banner-img Height 80%"><img src="assets\images\services\service8.png" alt="banner" style="max-width: 80%;margin-left: 10%;"></div>
            </div><!-- /.col-lg-6 -->
          <div class="col-sm-12 col-md-12 col-lg-7">
                <div class="banner-content">
                    <div class="heading-layout2 mb-50">
