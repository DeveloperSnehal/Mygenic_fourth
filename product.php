        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Anti Cancer Capsules</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #2 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Anti Cancer Injection</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #3 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Anti Cancer Tablets</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #4 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Anti Fungals Medicines</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #5 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Anti Hiv Medicines</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #6 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Arthritis Medicines</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #7 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Contrast Media</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #8 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Hepatitis C Medicines</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #9 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Hormones Medicines</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #10 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Life Saving Medicines</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #11 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Nephrology & Kidney Medicines</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #12 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">New Products</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #13 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Pharmaceutical Medicines</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #14 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Psoriasis Medicine</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
          <!-- Product item #15 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Skin & Cosmetology</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
         <!-- Product item #16 -->
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product-info">
                <h4 class="product-title"><a href="#">Vaccines</a></h4>
              </div><!-- /.product-content -->
            </div><!-- /.product-item -->
          </div><!-- /.col-lg-3 -->
        </div><!-- /.row -->
