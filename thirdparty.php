<?php include("header.php"); ?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
            <h1 class="pagetitle-heading">Third Party Pharma Manufacturer</h1>
        ...
        <div class="container">
          <nav>
            <ol class="breadcrumb mb-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Third Party Pharma Manufacturer</li>
            </ol>
          </nav>
        </div><!-- /.container -->
      </div><!-- /.breadcrumb-area -->
    ...
    <div class="heading-layout2 text-center mt-30">
        <h3 class="heading-title">Third Party Pharma <span style="color:#ed6f1e;">Manufacturer</span></h3>
    </div><!-- /heading -->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-5 px-0 d-flex justify-content-end">
             <div class="banner-img"><img src="assets\images\services\third_party_manufacturer.jpg" alt="banner" style="max-width: 90%;  border-radius: 50%;"></div>
          </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
    ...
    <section class="banner-layout5 py-0 mb-30">
      <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-5 px-0 d-flex justify-content-end">
                <div class="banner-img Height 80%"><img src="assets\images\services\services3.png" alt="banner" style="max-width: 80%;margin-left: 10%;"></div>
            </div><!-- /.col-lg-6 -->
          <div class="col-sm-12 col-md-12 col-lg-7">
                <div class="banner-content">
                    <div class="heading-layout2 mb-50">
